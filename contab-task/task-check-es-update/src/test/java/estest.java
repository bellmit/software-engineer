...
public class estest {
    ...
    public void init() throws Exception {
        ...
        client = new PreBuiltTransportClient(settings)
                .addTransportAddresses(new TransportAddress(InetAddress.getByName("192.168.177.11"), 9300))
                .addTransportAddresses(new TransportAddress(InetAddress.getByName("192.168.177.12"), 9300))
                .addTransportAddresses(new TransportAddress(InetAddress.getByName("192.168.177.13"), 9300));
