...
//           conf.set("hbase.rootdir", "hdfs://node01:16000/hbase");
////            //使用eclipse时必须添加这个，否则无法定位
////
////
/////           conf.set("hbase.zookeeper.quorum", "node01,node02,node03");
////            conf.set("hbase.client.scanner.timeout.period", "600000");
////            conf.set("hbase.master.port", "node02:16000");
////            conf.set("hbase.rpc.timeout", "600000");
////            conf.set("hbase.zookeeper.quorum", "node01,node02,node03");
////            conf.set("hbase.zookeeper.property.clientPort", "2181");
//.ConnectTimeoutException: 10000 millis timeout while waiting for channel to be ready for connect.
...
//        HTableDescriptor tableDescriptor = admin.getTableDescriptor(TableName.valueOf(tableName));
    ...
    public static void main(String[] args) throws Exception {
        ...
        //System.out.println(tableExists("ll"));
       // createTable(HBaseUtil.getConnection(),"ddl","f1");
    }
