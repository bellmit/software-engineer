...
public class Version2 {
    ...
    static String GIRL = "";
    static String BOY = "";
    static String[] PRO = new String[]{};
    static String[] EMAIL_SUFFIX = new String[]{};
    static String[] TEL_FIRST = new String[]{};
  ...
  /* private static String getAddress() {
    ...
    public static Map<String, String> getData() {
        ...
        map.put("commodityId", getCommodityId());
        return map;
    }
    ...
    public static String getCommodityId() {
        char[] chars = {'q', 'w', 'e', 'r', 't', 'y', 'u', 'i', 'o', 'p', 'l', 'k', 'j', 'h', 'g', 'f', 'd', 's', 'a', 'z', 'x', 'c', 'v', 'b', 'n', 'm'};

        return chars[randon.nextInt()] + "" + chars[randon.nextInt()] + chars[randon.nextInt()] + chars[randon.nextInt()] + randon.nextInt(501);
    }
